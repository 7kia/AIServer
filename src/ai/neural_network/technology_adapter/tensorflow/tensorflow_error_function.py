...
class TensorflowErrorFunction(ErrorFunction):
    ...
    def set_game_states(self, current_game_state: GameState, last_game_state: GameState):
        self._current_game_state: GameState = current_game_state
        self._last_game_state: GameState = last_game_state
