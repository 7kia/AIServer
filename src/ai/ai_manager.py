...
class AiManager:
    ...
    def _add_ai_to_list(self, game_id: int, player_id: int,
        ...
        self._add_to_dict(
            self._ai_list,
            game_id, player_id,
            AiBuilderDirector.create_ai(ai_info, game_info)
        )
    ...
    def _add_to_dict(self,
                     ...
                     add_value: any):
        if str(game_id) not in dictionary:
            dictionary.update({game_id: {}})
        dictionary[str(game_id)].update({
            player_id: add_value
        })
    ...
    def _add_ai_awards_definer_to_list(self, ai: Ai, game_info: GameInfo):
        self._add_to_dict(
            ...
            self._ai_awards_definer_director.create_for_ai(ai)
        )
    ...
    def add_ai_socket_connection_info(self, game_id, player_id):
        self._add_to_dict(
            self._ai_socket_connection_info,
            game_id, player_id,
            AiManager.generate_ai_address(game_id, player_id)
        )
